...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        .route(
            ...
            post(unimplemented_put_vector_bucket_policy),
        )
        .route(
            "/GetVectorBucketPolicy",
            post(unimplemented_get_vector_bucket_policy),
        )
        .route(
            "/DeleteVectorBucketPolicy",
            post(unimplemented_delete_vector_bucket_policy),
        )
        .route(
            "/ListTagsForResource",
            post(unimplemented_list_tags_for_resource),
        )
...
unimplemented_handler!(
    unimplemented_put_vector_bucket_policy,
    "PutVectorBucketPolicy"
);
unimplemented_handler!(
    unimplemented_get_vector_bucket_policy,
    "GetVectorBucketPolicy"
);
unimplemented_handler!(
    unimplemented_delete_vector_bucket_policy,
    "DeleteVectorBucketPolicy"
);
